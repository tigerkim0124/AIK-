      ...
      <div className="relative z-50 max-w-7xl mx-auto px-6">
        ...
        >
          <h1 className="font-display font-bold leading-[0.9] tracking-[-0.05em] text-black mb-8 flex flex-col items-center">
            <span className="text-2xl md:text-3xl lg:text-4xl mb-4 text-black/60 font-bold tracking-tight">
              AI+KOREA+CONTENTS
            </span>
            <span className="text-5xl md:text-7xl lg:text-[8.5rem] font-black tracking-[-0.07em] leading-none">
